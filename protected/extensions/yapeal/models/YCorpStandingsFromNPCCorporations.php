...
/**
 * This is the model class for table "yapeal_corpStandingsFromNPCCorporations".
 *
 * The followings are the available columns in table 'yapeal_corpStandingsFromNPCCorporations':
 * @property string $ownerID
 * @property string $fromID
 * @property string $fromName
 * @property string $standing
 */
class YCorpStandingsFromNPCCorporations extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return YCorpStandingsFromNPCCorporations the static model class
	 */
	...
	{
		return 'yapeal_corpStandingsFromNPCCorporations';
	}
