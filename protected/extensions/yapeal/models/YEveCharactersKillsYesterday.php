...
/**
 * This is the model class for table "yapeal_eveCharactersKillsYesterday".
 *
 * The followings are the available columns in table 'yapeal_eveCharactersKillsYesterday':
 * @property string $characterID
 * @property string $characterName
 * @property string $kills
 */
class YEveCharactersKillsYesterday extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return YEveCharactersKillsYesterday the static model class
	 */
	...
	{
		return 'yapeal_eveCharactersKillsYesterday';
	}
