...
/**
 * This is the model class for table "yapeal_charStandingsFromNPCCorporations".
 *
 * The followings are the available columns in table 'yapeal_charStandingsFromNPCCorporations':
 ...
 */
class YCharStandingsFromNPCCorporations extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return YCharStandingsFromNPCCorporations the static model class
	 */
	...
	{
		return 'yapeal_charStandingsFromNPCCorporations';
	}
