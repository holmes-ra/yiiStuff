...
/**
 * This is the model class for table "yapeal_charCorporationRolesAtHQ".
 *
 * The followings are the available columns in table 'yapeal_charCorporationRolesAtHQ':
 ...
 */
class YCharCorporationRolesAtHQ extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return YCharCorporationRolesAtHQ the static model class
	 */
	...
	{
		return 'yapeal_charCorporationRolesAtHQ';
	}
