...
/**
 * This is the model class for table "yapeal_corpWalletTransactions".
 *
 * The followings are the available columns in table 'yapeal_corpWalletTransactions':
 ...
 */
class YCorpWalletTransactions extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return YCorpWalletTransactions the static model class
	 */
	...
	{
		return 'yapeal_corpWalletTransactions';
	}
	...
	public function rules()
	{
		...
		return array(
			...
			array('ownerID, characterID, clientID, journalTransactionID, quantity, stationID, transactionID, typeID', 'length', 'max'=>20),
			array('characterName, clientName, stationName, transactionFor, transactionType, typeName', 'length', 'max'=>255),
			array('price', 'length', 'max'=>17),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('ownerID, accountKey, characterID, characterName, clientID, clientName, journalTransactionID, price, quantity, stationID, stationName, transactionDateTime, transactionFor, transactionID, transactionType, typeID, typeName', 'safe', 'on'=>'search'),
		);
	}
