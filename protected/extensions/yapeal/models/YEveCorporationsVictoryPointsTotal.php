...
/**
 * This is the model class for table "yapeal_eveCorporationsVictoryPointsTotal".
 *
 * The followings are the available columns in table 'yapeal_eveCorporationsVictoryPointsTotal':
 * @property string $corporationID
 * @property string $corporationName
 * @property string $victoryPoints
 */
class YEveCorporationsVictoryPointsTotal extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return YEveCorporationsVictoryPointsTotal the static model class
	 */
	...
	{
		return 'yapeal_eveCorporationsVictoryPointsTotal';
	}
