...
/**
 * This is the model class for table "yapeal_corpMarketOrders".
 *
 * The followings are the available columns in table 'yapeal_corpMarketOrders':
 ...
 */
class YCorpMarketOrders extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return YCorpMarketOrders the static model class
	 */
	...
	{
		return 'yapeal_corpMarketOrders';
	}
