...
/**
 * This is the model class for table "yapeal_corpStandingsFromAgents".
 *
 * The followings are the available columns in table 'yapeal_corpStandingsFromAgents':
 * @property string $ownerID
 * @property string $fromID
 * @property string $fromName
 * @property string $standing
 */
class YCorpStandingsFromAgents extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return YCorpStandingsFromAgents the static model class
	 */
	...
	{
		return 'yapeal_corpStandingsFromAgents';
	}
