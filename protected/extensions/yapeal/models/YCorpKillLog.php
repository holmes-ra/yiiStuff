...
/**
 * This is the model class for table "yapeal_corpKillLog".
 *
 * The followings are the available columns in table 'yapeal_corpKillLog':
 * @property string $killID
 * @property string $killTime
 * @property string $moonID
 * @property string $solarSystemID
 */
class YCorpKillLog extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return YCorpKillLog the static model class
	 */
