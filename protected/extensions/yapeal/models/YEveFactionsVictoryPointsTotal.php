...
/**
 * This is the model class for table "yapeal_eveFactionsVictoryPointsTotal".
 *
 * The followings are the available columns in table 'yapeal_eveFactionsVictoryPointsTotal':
 * @property string $factionID
 * @property string $factionName
 * @property string $victoryPoints
 */
class YEveFactionsVictoryPointsTotal extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return YEveFactionsVictoryPointsTotal the static model class
	 */
	...
	{
		return 'yapeal_eveFactionsVictoryPointsTotal';
	}
