...
/**
 * This is the model class for table "yapeal_eveCorporationsKillsTotal".
 *
 * The followings are the available columns in table 'yapeal_eveCorporationsKillsTotal':
 * @property string $corporationID
 * @property string $corporationName
 * @property string $kills
 */
class YEveCorporationsKillsTotal extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return YEveCorporationsKillsTotal the static model class
	 */
	...
	{
		return 'yapeal_eveCorporationsKillsTotal';
	}
