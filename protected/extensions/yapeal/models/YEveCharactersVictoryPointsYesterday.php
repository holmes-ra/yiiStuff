...
/**
 * This is the model class for table "yapeal_eveCharactersVictoryPointsYesterday".
 *
 * The followings are the available columns in table 'yapeal_eveCharactersVictoryPointsYesterday':
 * @property string $characterID
 * @property string $characterName
 * @property string $victoryPoints
 */
class YEveCharactersVictoryPointsYesterday extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return YEveCharactersVictoryPointsYesterday the static model class
	 */
	...
	{
		return 'yapeal_eveCharactersVictoryPointsYesterday';
	}
