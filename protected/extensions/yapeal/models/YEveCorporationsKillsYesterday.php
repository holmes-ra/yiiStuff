...
/**
 * This is the model class for table "yapeal_eveCorporationsKillsYesterday".
 *
 * The followings are the available columns in table 'yapeal_eveCorporationsKillsYesterday':
 * @property string $corporationID
 * @property string $corporationName
 * @property string $kills
 */
class YEveCorporationsKillsYesterday extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return YEveCorporationsKillsYesterday the static model class
	 */
	...
	{
		return 'yapeal_eveCorporationsKillsYesterday';
	}
