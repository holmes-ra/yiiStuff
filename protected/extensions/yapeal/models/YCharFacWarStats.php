...
/**
 * This is the model class for table "yapeal_charFacWarStats".
 *
 * The followings are the available columns in table 'yapeal_charFacWarStats':
 ...
 */
class YCharFacWarStats extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return YCharFacWarStats the static model class
	 */
