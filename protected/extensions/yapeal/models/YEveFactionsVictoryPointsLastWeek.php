...
/**
 * This is the model class for table "yapeal_eveFactionsVictoryPointsLastWeek".
 *
 * The followings are the available columns in table 'yapeal_eveFactionsVictoryPointsLastWeek':
 * @property string $factionID
 * @property string $factionName
 * @property string $victoryPoints
 */
class YEveFactionsVictoryPointsLastWeek extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return YEveFactionsVictoryPointsLastWeek the static model class
	 */
	...
	{
		return 'yapeal_eveFactionsVictoryPointsLastWeek';
	}
