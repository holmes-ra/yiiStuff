...
/**
 * This is the model class for table "yapeal_corpItems".
 *
 * The followings are the available columns in table 'yapeal_corpItems':
 ...
 */
class YCorpItems extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return YCorpItems the static model class
	 */
