...
/**
 * This is the model class for table "yapeal_charStandingsFromAgents".
 *
 * The followings are the available columns in table 'yapeal_charStandingsFromAgents':
 ...
 */
class YCharStandingsFromAgents extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return YCharStandingsFromAgents the static model class
	 */
	...
	{
		return 'yapeal_charStandingsFromAgents';
	}
