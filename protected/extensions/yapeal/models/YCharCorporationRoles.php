...
/**
 * This is the model class for table "yapeal_charCorporationRoles".
 *
 * The followings are the available columns in table 'yapeal_charCorporationRoles':
 ...
 */
class YCharCorporationRoles extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return YCharCorporationRoles the static model class
	 */
	...
	{
		return 'yapeal_charCorporationRoles';
	}
