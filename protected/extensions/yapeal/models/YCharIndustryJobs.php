...
/**
 * This is the model class for table "yapeal_charIndustryJobs".
 *
 * The followings are the available columns in table 'yapeal_charIndustryJobs':
 ...
 */
class YCharIndustryJobs extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return YCharIndustryJobs the static model class
	 */
	...
	{
		return 'yapeal_charIndustryJobs';
	}
