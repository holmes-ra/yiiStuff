...
/**
 * This is the model class for table "yapeal_charWalletJournal".
 *
 * The followings are the available columns in table 'yapeal_charWalletJournal':
 ...
 * @property string $taxReceiverID
 *
 * The followings are the available model relations:
 * @property YUtilRegisteredCharacter $owner
 */
class YCharWalletJournal extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return YCharWalletJournal the static model class
	 */
	...
	{
		return 'yapeal_charWalletJournal';
	}
	...
	public function rules()
	{
		...
		return array(
			array('ownerID, accountKey, amount, balance, date, refID, refTypeID, taxAmount', 'required'),
			array('accountKey', 'numerical', 'integerOnly'=>true),
			array('ownerID, argID1, ownerID1, ownerID2, refID, taxReceiverID', 'length', 'max'=>20),
			array('amount, balance, taxAmount', 'length', 'max'=>17),
			array('argName1, ownerName1, ownerName2', 'length', 'max'=>255),
			array('refTypeID', 'length', 'max'=>3),
			array('reason', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('ownerID, accountKey, amount, argID1, argName1, balance, date, ownerID1, ownerID2, ownerName1, ownerName2, reason, refID, refTypeID, taxAmount, taxReceiverID', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('taxReceiverID',$this->taxReceiverID,true);
