...
/**
 * This is the model class for table "yapeal_eveCharactersKillsTotal".
 *
 * The followings are the available columns in table 'yapeal_eveCharactersKillsTotal':
 * @property string $characterID
 * @property string $characterName
 * @property string $kills
 */
class YEveCharactersKillsTotal extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return YEveCharactersKillsTotal the static model class
	 */
	...
	{
		return 'yapeal_eveCharactersKillsTotal';
	}
