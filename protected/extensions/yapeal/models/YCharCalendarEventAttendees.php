...
/**
 * This is the model class for table "yapeal_charCalendarEventAttendees".
 *
 * The followings are the available columns in table 'yapeal_charCalendarEventAttendees':
 ...
 */
class YCharCalendarEventAttendees extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return YCharCalendarEventAttendees the static model class
	 */
	...
	{
		return 'yapeal_charCalendarEventAttendees';
	}
