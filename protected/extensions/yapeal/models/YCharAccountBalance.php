...
/**
 * This is the model class for table "yapeal_charAccountBalance".
 *
 * The followings are the available columns in table 'yapeal_charAccountBalance':
 ...
 */
class YCharAccountBalance extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return YCharAccountBalance the static model class
	 */
	...
	{
		return 'yapeal_charAccountBalance';
	}
