...
/**
 * This is the model class for table "yapeal_corpAssetList".
 *
 * The followings are the available columns in table 'yapeal_corpAssetList':
 ...
 */
class YCorpAssetList extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return YCorpAssetList the static model class
	 */
