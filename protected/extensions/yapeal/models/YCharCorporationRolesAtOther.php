...
/**
 * This is the model class for table "yapeal_charCorporationRolesAtOther".
 *
 * The followings are the available columns in table 'yapeal_charCorporationRolesAtOther':
 ...
 */
class YCharCorporationRolesAtOther extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return YCharCorporationRolesAtOther the static model class
	 */
	...
	{
		return 'yapeal_charCorporationRolesAtOther';
	}
