...
/**
 * This is the model class for table "yapeal_eveCharactersVictoryPointsTotal".
 *
 * The followings are the available columns in table 'yapeal_eveCharactersVictoryPointsTotal':
 * @property string $characterID
 * @property string $characterName
 * @property string $victoryPoints
 */
class YEveCharactersVictoryPointsTotal extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return YEveCharactersVictoryPointsTotal the static model class
	 */
	...
	{
		return 'yapeal_eveCharactersVictoryPointsTotal';
	}
