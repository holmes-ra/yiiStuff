...
/**
 * This is the model class for table "yapeal_eveCorporationsVictoryPointsLastWeek".
 *
 * The followings are the available columns in table 'yapeal_eveCorporationsVictoryPointsLastWeek':
 * @property string $corporationID
 * @property string $corporationName
 * @property string $victoryPoints
 */
class YEveCorporationsVictoryPointsLastWeek extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return YEveCorporationsVictoryPointsLastWeek the static model class
	 */
	...
	{
		return 'yapeal_eveCorporationsVictoryPointsLastWeek';
	}
