...
/**
 * This is the model class for table "yapeal_corpContracts".
 *
 * The followings are the available columns in table 'yapeal_corpContracts':
 ...
 */
class YCorpContracts extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return YCorpContracts the static model class
	 */
