...
/**
 * This is the model class for table "yapeal_corpCorporateContactList".
 *
 * The followings are the available columns in table 'yapeal_corpCorporateContactList':
 * @property string $ownerID
 * @property string $contactID
 * @property string $contactName
 * @property string $standing
 */
class YCorpCorporateContactList extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return YCorpCorporateContactList the static model class
	 */
	...
	{
		return 'yapeal_corpCorporateContactList';
	}
