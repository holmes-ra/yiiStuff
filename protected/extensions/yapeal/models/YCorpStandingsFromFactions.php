...
/**
 * This is the model class for table "yapeal_corpStandingsFromFactions".
 *
 * The followings are the available columns in table 'yapeal_corpStandingsFromFactions':
 * @property string $ownerID
 * @property string $fromID
 * @property string $fromName
 * @property string $standing
 */
class YCorpStandingsFromFactions extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return YCorpStandingsFromFactions the static model class
	 */
	...
	{
		return 'yapeal_corpStandingsFromFactions';
	}
