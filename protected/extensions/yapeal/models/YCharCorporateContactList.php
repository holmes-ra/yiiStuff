...
/**
 * This is the model class for table "yapeal_charCorporateContactList".
 *
 * The followings are the available columns in table 'yapeal_charCorporateContactList':
 ...
 */
class YCharCorporateContactList extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return YCharCorporateContactList the static model class
	 */
	...
	{
		return 'yapeal_charCorporateContactList';
	}
