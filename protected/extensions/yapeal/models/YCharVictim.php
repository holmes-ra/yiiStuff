...
/**
 * This is the model class for table "yapeal_charVictim".
 *
 * The followings are the available columns in table 'yapeal_charVictim':
 ...
 */
class YCharVictim extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return YCharVictim the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('killID, allianceID, characterID, corporationID, damageTaken, factionID, shipTypeID', 'required'),
