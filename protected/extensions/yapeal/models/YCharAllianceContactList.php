...
/**
 * This is the model class for table "yapeal_charAllianceContactList".
 *
 * The followings are the available columns in table 'yapeal_charAllianceContactList':
 ...
 */
class YCharAllianceContactList extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return YCharAllianceContactList the static model class
	 */
	...
	{
		return 'yapeal_charAllianceContactList';
	}
