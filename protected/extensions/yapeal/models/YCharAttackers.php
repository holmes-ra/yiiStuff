...
/**
 * This is the model class for table "yapeal_charAttackers".
 *
 * The followings are the available columns in table 'yapeal_charAttackers':
 ...
 */
class YCharAttackers extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return YCharAttackers the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('killID, allianceID, characterID, corporationID, factionID, finalBlow, securityStatus, shipTypeID, weaponTypeID', 'required'),
